 ...
 */
public class Ejercicios_Ventana8 extends javax.swing.JFrame {
    
    public Ejercicios_Ventana8() {
        ...
        jcbNegrita.setBounds(0, 570, 150, 30);
        
        add(jcbNegrita);
        
        JCheckBox jcbCursiva = new JCheckBox("Cursiva");
        
        jcbCursiva.setBounds(180, 570, 150, 30);
        
        add(jcbCursiva);        
    }
    
    public static void main(String[] args) {
        new Ejercicios_Ventana8();
    } 
}
